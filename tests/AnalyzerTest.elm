...
simplePath =
    "sz:3,1;st:0,0;end:2,0;mz:o0o0o0"
        |> Codec.decode
        |> Maybe.withDefault emptyMaze


loopMaze =
    "sz:3,3;st:0,0;end:2,0;mz:o0o0o0o0xo0o0o0o0"
        |> Codec.decode
        |> Maybe.withDefault emptyMaze


isolatedMaze =
    "sz:3,3;st:0,0;end:2,2;mz:xxo0xxxxo0xx"
        |> Codec.decode
        |> Maybe.withDefault emptyMaze


bridgeMaze =
    "sz:3,1;st:0,0;end:2,0;mz:o1l1o1"
        |> Codec.decode
        |> Maybe.withDefault emptyMaze


stairsMaze =
    "sz:2,1;st:0,0;end:1,0;mz:o0s1"
        |> Codec.decode
        |> Maybe.withDefault emptyMaze
...
suite =
    describe "Analyzer Test"
        ...
        , describe "Bridge Maze"
            ...
            , test "Total Cells" <| \_ -> (analyze bridgeMaze).totalCells |> Expect.equal 4 -- o1, l1 (top), l1 (bottom), o1. Wait, bridge is (x,y,z) and (x,y,z-1).
