            ...
            case overlay of
                Help ->
                    ...
                    , H.div [ HA.class "modal-footer" ]
                        [ H.text "© "
                        , H.a [ HA.href "https://tasuki.org" ] [ H.text "tasuki" ]
                        , H.br [] []
                        , H.text "report bugs to "
                        , H.a [ HA.href "https://github.com/tasuki/iso-maze/issues" ] [ H.text "https://github.com/tasuki/iso-maze/issues" ]
                        ]
                    ]
