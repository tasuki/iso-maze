...
function createHaloTexture() {
    ...
    grad.addColorStop(0.7, 'rgba(0, 204, 255, 0.2)');
    grad.addColorStop(0.8, 'rgba(0, 204, 255, 0.4)');
    grad.addColorStop(0.9, 'rgba(0, 204, 255, 0)');
    ctx.fillStyle = grad;
...
const materials = {
    ...
    stripe: new THREE.MeshBasicMaterial({ color: 0x000000, transparent: true, opacity: 0.3, depthWrite: false }),
};
