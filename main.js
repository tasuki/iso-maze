...
const materials = {
    ...
    debugUnreachable: new THREE.MeshStandardMaterial({ color: 0x000000, roughness: 0.8, metalness: 0.2 }),
    debugOccluding: new THREE.MeshStandardMaterial({ color: 0xff0000, roughness: 0.8, metalness: 0.2 }),
};
